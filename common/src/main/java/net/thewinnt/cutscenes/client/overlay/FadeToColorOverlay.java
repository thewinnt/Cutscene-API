...
public class FadeToColorOverlay implements Overlay {
    ...
    public void render(Minecraft minecraft, GuiGraphics graphics, int width, int height, Object config) {
        ...
        builder.addVertex(pose, 0, height, -2).setColor(colorBottomLeft[0], colorBottomLeft[1], colorBottomLeft[2], colorBottomLeft[3] * alpha);
        builder.addVertex(pose, width, height, -2).setColor(colorBottomRight[0], colorBottomRight[1], colorBottomRight[2], colorBottomRight[3] * alpha);
        builder.addVertex(pose, width, 0, -2).setColor(colorTopRight[0], colorTopRight[1], colorTopRight[2], colorTopRight[3] * alpha);
        builder.addVertex(pose, 0, 0, -2).setColor(colorTopLeft[0], colorTopLeft[1], colorTopLeft[2], colorTopLeft[3] * alpha);

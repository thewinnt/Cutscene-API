...
public class ClientServices {
    ...
    // mod is loaded.
    public static final ClientPlatformAbstractions PLATFORM = load(ClientPlatformAbstractions.class);
    ...
    public static <T> T load(Class<T> clazz) {
        ...
        CutsceneAPI.LOGGER.debug("Loaded {} for service {}", loadedService, clazz);

...
public class FadeToColorOverlay {
    ...
    public static float[] colorBottomLeft = new float[]{1, 0, 0, 1};
    public static float[] colorTopLeft = new float[]{0, 1, 0, 1};
    public static float[] colorTopRight = new float[]{0, 0, 1, 1};
    public static float[] colorBottomRight = new float[]{1, 1, 1, 1};
